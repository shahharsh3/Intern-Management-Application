...
public class ProjectAllocationAPI
{
    ...
    {
		List<MentorDTO> mentorDTO = projectService.getMentors(numberOfProjectsMentored);
    ...
    public ResponseEntity<String> updateProjectMentor(@PathVariable Integer projectId,
    		@PathVariable @Min(value = 1000, message = "{mentor.mentorid.invalid}") @Max(value = 9999, message = "{mentor.mentorid.invalid}") Integer mentorId) throws InternException
    {
